...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      /*
       * Do not expose the reset token or reset URL to the client.
       * The reset link is sent securely through Resend.
       */
      setIsSent(true);
    } catch {
            ...
            <div>
              ...
              <div className="mt-24 max-w-sm">
                ...
                <p className="mt-5 text-sm leading-7 text-white/50">
                  Reset your Gym Admin password through a secure, time-limited
                  recovery link.
                </p>
              </div>
            </div>
          ...
          <section className="flex min-h-[620px] items-center bg-neutral-950/70 p-6 sm:p-10 lg:p-12">
            <div className="mx-auto w-full max-w-md">
              ...
              <button
                ...
                className="mb-10 text-xs font-medium text-white/40 transition-colors hover:text-white/75"
              >
                ← Back to login
              </button>
              ...
              {isSent ? (
                <div className="animate-fade-in">
                  ...
                  <p className="mt-8 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-400/80">
                    Email sent
                  </p>
                  ...
                  <Button
                    variant="outline"
                    className="mt-7 h-11 w-full border-white/10 bg-white/[0.04] text-white hover:bg-white/[0.08] hover:text-white"
                    onClick={() => router.replace("/login")}
                  >
                    Return to login
                  </Button>
                ...
                <>
                  ...
                  <p className="mt-8 text-xs font-semibold uppercase tracking-[0.2em] text-white/35">
                    Password recovery
                  </p>
                  ...
                  <p className="mt-4 text-sm leading-7 text-white/45">
                    Enter the email connected to your Gym Admin account and
                  ...
                  >
                    ...
                    {error ? (
                      <div
                        className="flex items-start gap-2 rounded-xl border border-red-400/15 bg-red-400/[0.06] px-4 py-3 text-sm text-red-300"
                        role="alert"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="h-12 border-white/10 bg-white/[0.04] pl-10 text-white placeholder:text-white/20 focus:border-emerald-400/40 focus:ring-emerald-400/10"
                        />
                      </div>
                    </div>
                    ...
                    <Button
                      type="submit"
                      className="h-12 w-full bg-emerald-500 font-semibold text-neutral-950 shadow-lg shadow-emerald-500/10 hover:bg-emerald-400"
